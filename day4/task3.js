var crudApp = new function () {
    ...
    this.myBooks = [
        { ID: '1', Book_Name: 'Computer Architecture', Category: 'Computers', Country:'INDIA',Email:"ca@abc.in",Price: 125.60 },
        { ID: '2', Book_Name: 'Asp.Net 4 Blue Book', Category: 'Programming', Country:'US',Email:"asp@abc.in",Price: 56.00 },
        { ID: '3', Book_Name: 'Popular Science', Category: 'Science',Country:'UK',Email:"ps@abc.in", Price: 210.40 }
    ]

    this.category = ['Business', 'Computers', 'Programming', 'Science'];
    this.country = ['UK','US','INDIA','GERMANY']
    this.col = [];
